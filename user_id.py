...
# Example command to define person 42
# dbus-send --dest=org.BaristaBot.user_id --print-reply /org/BaristaBot/user_id org.BaristaBot.UserIdInterface.definePerson int32:42
...
class UserIdentifier(dbus.service.Object):
    ...
    def __init__(self, main_loop):
        ...
        super(UserIdentifier, self).__init__(bus_name, self.Object_Path)
    ...
    @dbus.service.method(Interface_Name, in_signature='i', out_signature='s')
...
def main():
    ...
    ider = UserIdentifier(main_loop)

    gobject.timeout_add(50, ider.doIteration)
